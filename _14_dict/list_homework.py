...
for student in students:
    if student["grades"] is not None:
        ...
        if average_mark > best_average_grade:
            best_student = student
            best_average_grade = average_mark
print(f"The best student is {best_student['name']}{best_student['surname']} with an average grade of {best_average_grade:.2f}")
